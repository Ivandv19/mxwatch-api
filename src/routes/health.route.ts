...
export const healthRoute = createRoute({
  ...
  description: 'Verifica la conectividad con la base de datos y el estado general del runtime del servidor.',
  responses: {
    200: {
      content: {
        'application/json': {
      ...
      description: 'El servidor y la base de datos están operando correctamente (VIVO).',
    },
    503: {
      content: {
        'application/json': {
      ...
      description: 'El servidor o la base de datos están fuera de servicio (MUERTO/CRITICAL).',
    },
  },
});
